                        ...
                        <div className="sm:flex sm:-mx-2 pl-2">
                            <label htmlFor="existencia" className="block mt-5 sm:w-2/4">
                                ...
                                <select
                                    ...
                                    value={existencia}
                                    ref={existenciaRef}
                                    onChange={() => actualizarDisponibiliad()}
                                    className="shadow appearance-none border rounded w-full py-2 px-2 leading-tight focus:outline-none focus:shadow-outline">
                                    <option value="true">Disponible</option>
                                    <option value="false">No Disnonible</option>
                                </select>
                            </label>
                        </div>
                    </div>
